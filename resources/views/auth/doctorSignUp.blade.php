                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-12 col-lg-6 login-right">
                            <div class="login-header">
                                <h3>Teacher Registration Panel <a href="{{ route('register') }}">Not a Teacher? Are You User ?</a></h3>
                                @if (count($errors)>0)
                                    <ul>
                            ...
                            <form action="{{ route('doctorSignUpFormSubmit') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-focus">
                                    <input type="text" name="teacher_varsity_id" class="form-control floating">
                                    <label class="focus-label">Teacher ID Number</label>
                                </div>
